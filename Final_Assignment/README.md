...
IGV visualization of a high-confidence variant at position **103048** (T→A substitution):

<p align="center">
  <img src="docs/igv_variant_visualization.png" width="900" alt="IGV visualization of variant at position 103048">
</p>

**What you're seeing:**
- **Green column**: Position 103048 from reference genome
- **Green 'A' bases**: Individual reads showing the alternate allele (A)
- **Gray bars**: Aligned reads spanning the region
- **Configuration**: Visualization of a homozygous variant (1/1 genotype) with 21 reads supporting the A allele
